...
namespace Memberships.Areas.Admin.Controllers
{
    ...
    public class ItemController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Title,Description,Url,ImageUrl,HTML,WaitDays,ItemTypeId,SectionId,PartId,IsFree")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Title,Description,Url,ImageUrl,HTML,WaitDays,ItemTypeId,SectionId,PartId,IsFree")] Item item)
        {
            if (ModelState.IsValid)
            {
        ...
        public async Task<ActionResult> DeleteConfirmed(int id)
        {
                ...
                TransactionScopeAsyncFlowOption.Enabled))
            {
                try
                {
                    var prodItems = db.ProductItems.Where(pi =>
                    pi.ItemId.Equals(id));
